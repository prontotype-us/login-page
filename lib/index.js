...
App = React.createClass({displayName: "App",
  ...
  render: function() {
    var links, login_tab, login_tab_class, path, ref1, ref2, ref3, signup_tab, signup_tab_class, tabs;
    ...
    return React.createElement("div", {
      ...
      "id": 'login-inner'
    }, ((ref1 = options[path]) != null ? ref1.intro : void 0), ((ref2 = options[path]) != null ? ref2.befores : void 0), React.cloneElement(this.props.children, options[path]), links[path], ((ref3 = options[path]) != null ? ref3.extras : void 0)), options.footer);
  }
});
