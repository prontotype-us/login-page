...
var App, Dispatcher, ForgotForm, ForgotSuccess, IndexRoute, Link, LoginForm, LoginMixin, LoginPage, React, ResetForm, ResetSuccess, Route, Router, SignupForm, ValidatedFormMixin, browserHistory, confirm_password_field, email_field, fetch$, hashHistory, history, password_field, ref, setNext, token_field;
...
App = React.createClass({displayName: "App",
  ...
  render: function() {
    ...
    return React.createElement("div", {
      ...
      "id": 'login-inner'
    }, ((ref1 = options[path]) != null ? ref1.extras : void 0), React.cloneElement(this.props.children, options[path]), links[path]), options.footer);
  }
});
