...
var App, Dispatcher, ForgotForm, ForgotSuccess, IndexRoute, Link, LoginForm, LoginMixin, LoginPage, React, ResetForm, ResetSuccess, Route, Router, SignupForm, ValidatedFormMixin, browserHistory, confirm_password_field, email_field, fetch$, password_field, ref, setNext, token_field;
...
ForgotForm = React.createClass({displayName: "ForgotForm",
  ...
  render: function() {
    return React.createElement("div", null, React.createElement("h3", null, this.props.title), React.createElement("form", {
      "onSubmit": this.trySubmit
    }, this.renderField('email'), React.createElement("button", {
      "type": 'submit',
      "disabled": this.state.loading
...
ResetForm = React.createClass({displayName: "ResetForm",
  ...
  render: function() {
    return React.createElement("div", null, React.createElement("h3", null, this.props.title), React.createElement("form", {
      "onSubmit": this.trySubmit
    }, this.renderField('password'), this.renderField('confirm_password'), React.createElement("button", {
      "type": 'submit',
      "disabled": this.state.loading
...
App = React.createClass({displayName: "App",
  ...
  render: function() {
    ...
    links = {
      ...
      }, "« Nevermind") : void 0), (this.props.has_signup ? React.createElement(Link, {
        "to": {
          pathname: "/signup",
          query: this.props.location.query
        }
    ...
    return React.createElement("div", {
      "id": 'login-module',
      "className": 'section'
    }, React.cloneElement(this.props.children, options[path]), links[path]);
  }
});
